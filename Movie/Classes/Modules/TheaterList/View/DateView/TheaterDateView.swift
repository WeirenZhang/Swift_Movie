...
public protocol DateViewProtocol: AnyObject {

    func SetDateViewHeight(height: CGFloat)
}

public class TheaterDateView: UIView {
    
    public weak var delegate: DateViewProtocol?
    
    private let transparentView = UIView()
    
    /// 所有筛选数据
    public var date: [TheaterDateItemModel] = [] {
        didSet {
...
extension TheaterDateView: UITableViewDelegate, UITableViewDataSource {
...
public extension Reactive where Base: TheaterDateView {

    var date: Binder<[TheaterDateItemModel]> {
