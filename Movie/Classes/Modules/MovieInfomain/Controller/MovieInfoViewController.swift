...
class MovieInfoViewController: VMTableViewController<MovieInfoViewModel> {
    ...
    override func makeUI() {
        ...
        tableView.estimatedRowHeight = 950.0
        tableView.rowHeight = UITableView.automaticDimension
        tableView.register(MovieInfoCell.self, forCellReuseIdentifier: "Cell")
    ...
    override func bindViewModel() {
        ...
        let input = MovieInfoViewModel.Input(movie_id: self.model.id)
